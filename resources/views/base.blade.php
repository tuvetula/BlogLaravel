...
<nav class="navbar navbar-expand-lg navbar-light bg-info">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            @endif
            <li class="nav-item">
                <a href="{{ route('contact.edit') }}" class="nav-link @if (\Request::is('contact/*') || \Request::is('contact'))
        ...
        @auth('admin')
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="{{ route('backend.admins.index') }}">{{ __('Administrators') }} </a>
        ...
        @if (Route::has('login'))
            @auth
                <div class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle text-light" href="#" data-toggle="dropdown"
